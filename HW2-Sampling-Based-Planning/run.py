...
if __name__ == "__main__":
    ...
    # planner.planning_env.visualize_map()
    # plt=planner.planning_env.create_map_visualization()
    # plt=planner.planning_env.visualize_obstacles(plt=plt)
    # plt.show()
    # execute plan
    plan,total_cost = planner.plan()
    ...
    if args.planner == 'astar':
        ...
        # planner.planning_env.visualize_map(plan=plan, expanded_nodes=CLOSE_list)
    else:
